...
void main()
{
	...
	*/
	...
	//NOTE: We might choose to make these pullup inputs and get
	// rid of our external pullups. See also: reg_gpio_pu:
	...
	reg_mprj_io_11	= GPIO_MODE_USER_STD_INPUT_NOPULL;	// down_key_n
	reg_mprj_io_12	= GPIO_MODE_USER_STD_INPUT_NOPULL;	// up_key_n
